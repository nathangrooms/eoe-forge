...
/**
 * Every entry used to be `border-l-4 border-primary pl-4` — thirty-four hard
 * accent rules stacked down one scroll pane, which is the loudest hairline in
 * the product and the exact thing the design law rules out. An entry is a
 * tinted block now: the surface steps up, nothing is drawn on.
 */
