      ...
      <div className="mt-14 grid gap-5 lg:grid-cols-[minmax(0,1fr)_minmax(0,620px)]">
        ...
        <div className="rounded-2xl bg-card p-5 shadow-2xl shadow-black/40 sm:p-6">
          ...
          <p className="mt-4 text-[11px] leading-relaxed text-muted-foreground">
            A worked example: four real precon decks, two rounds played. Every figure above is
            returned by the app's own scoring module, and the round-three pairings by its own
