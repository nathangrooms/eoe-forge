 ...
 *   `chat.ts`      the rooms people talk in, which are topics, not a new table
 ...
 *
 * Added later, and the same rule holds for them:
 *
 *   `friends.ts`     who you know, what they let you see, and asking them over
 *   `friendsView.ts` the friends decisions and copy, pure, so tests reach them
 *   `presence.ts`    saying you are around, one row, on a heartbeat
 */
