-- Fix search_path security warnings for deck functions

-- Drop and recreate functions with proper search_path
DROP FUNCTION IF EXISTS public.compute_deck_summary(UUID);
DROP FUNCTION IF EXISTS public.toggle_deck_favorite(UUID);
DROP FUNCTION IF EXISTS public.get_favorite_decks();

-- Create deck summary computation function with secure search_path
...
-- Create deck favorites toggle function with secure search_path
...
-- Create function to get user's favorite decks with secure search_path
